...
class CustomLoginView(LoginView):
    ...
    def get(self, request, *args, **kwargs):
        """Override get method to ensure we show login form even if user is authenticated"""
        # Force logout any existing user to ensure clean login process
...
def debug_auth_view(request):
    """Debug view to check authentication state"""
    context = {
